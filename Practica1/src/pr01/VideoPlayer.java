...
public class VideoPlayer extends JFrame {
	...
	public VideoPlayer() {
		...
		bAnyadir.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ficheros = JOptionPane.showInputDialog(null, "Indica el filtro", "Selección de archivos", JOptionPane.INFORMATION_MESSAGE);
	...
	private static File pedirCarpeta() {
		...
		jfc.setMultiSelectionEnabled(false); // Solo se podrá elegir una carpeta a cada vez
	...
	public static void main(String[] args) {
		...
		if (args.length < 2) {
			...
			String filtro = JOptionPane.showInputDialog(null, "Indica el filtro", "Selección de archivos", JOptionPane.INFORMATION_MESSAGE);
			if(filtro != null) {
				ficheros = filtro;
			}
		} else {
